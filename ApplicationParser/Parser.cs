...
namespace ApplicationParser
{
    public class Parser
    {
        ...
        public ObjectDef ParseObject(XmlNode node)
        {
            ...
            var fields = node.SelectNodes("Fields").Item(0).SelectNodes("Field");
        ...
        private Field ParseField(XmlNode field)
        {
        ...
        private T ParseNode<T>(XmlNode node) where T :Artifact, new()
        {
