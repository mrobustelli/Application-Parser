...
namespace Test
{
	...
	public class Document 
	{
		...
		public string FileName{get { return this.RDO[Guid.Parse(DocumentFieldGuids.FileName)].ValueAsFixedLengthText; }set { this.RDO[Guid.Parse(DocumentFieldGuids.FileName)] = value; }}
		public object ContractType{get { return this.RDO[Guid.Parse(DocumentFieldGuids.ContractType)].Value; }set { this.RDO[Guid.Parse(DocumentFieldGuids.ContractType)] = value; }}
		public object SectionType{get { return this.RDO[Guid.Parse(DocumentFieldGuids.SectionType)].Value; }set { this.RDO[Guid.Parse(DocumentFieldGuids.SectionType)] = value; }}
		public object DocumentsAnalyzed{get { return this.RDO[Guid.Parse(DocumentFieldGuids.DocumentsAnalyzed)].Value; }set { this.RDO[Guid.Parse(DocumentFieldGuids.DocumentsAnalyzed)] = value; }}
		public object SectionsIdentified{get { return this.RDO[Guid.Parse(DocumentFieldGuids.SectionsIdentified)].Value; }set { this.RDO[Guid.Parse(DocumentFieldGuids.SectionsIdentified)] = value; }}
		public object Confidence{get { return this.RDO[Guid.Parse(DocumentFieldGuids.Confidence)].Value; }set { this.RDO[Guid.Parse(DocumentFieldGuids.Confidence)] = value; }}
	}

	public class ContractAnalysisJob 
	{
		public RDO RDO {get;set;}
		public object DocumentsAnalyzed{get { return this.RDO[Guid.Parse(ContractAnalysisJobFieldGuids.DocumentsAnalyzed)].Value; }set { this.RDO[Guid.Parse(ContractAnalysisJobFieldGuids.DocumentsAnalyzed)] = value; }}
		public object DataSource{get { return this.RDO[Guid.Parse(ContractAnalysisJobFieldGuids.DataSource)].Value; }set { this.RDO[Guid.Parse(ContractAnalysisJobFieldGuids.DataSource)] = value; }}
		public object JobType{get { return this.RDO[Guid.Parse(ContractAnalysisJobFieldGuids.JobType)].Value; }set { this.RDO[Guid.Parse(ContractAnalysisJobFieldGuids.JobType)] = value; }}
		public object ContractsAnalyzed{get { return this.RDO[Guid.Parse(ContractAnalysisJobFieldGuids.ContractsAnalyzed)].Value; }set { this.RDO[Guid.Parse(ContractAnalysisJobFieldGuids.ContractsAnalyzed)] = value; }}
	}

	public class HeretikConfiguration 
	{
		public RDO RDO {get;set;}
	}
